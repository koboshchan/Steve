        ...
        if True:
            try:
                ...
                for idx, env in enumerate(self.training_env.envs):
                    ...
                    l1 = f"C{idx} SELF: HP: {hp_val:>2d}/20 | Vel: ({vel_x:>+6.2f}, {vel_y:>+6.2f}, {vel_z:>+6.2f}) | Sprint: {sprint_str:<5} | GroundDist: {y_ground:>5.2f}m"
                    ...
                    l2 = f"C{idx} OPP:  HP: {opp_hp_val:>2d}/20 | Dist: {target_dist:>6.2f}m | RelPos: ({opp_rel_x:>+6.1f}, {opp_rel_y:>+6.1f}, {opp_rel_z:>+6.1f})"
